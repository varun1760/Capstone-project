...
<h3 style="color: orange">*If there is no address its mean that you did not set you address!</h3>
<h3 style="color: orange">*This address will also updated to your profile</h3>
<hr style="width: 100%">
<div class="left-div">
...
<div class="right-div">
<h3>Pay online on this varunrao1760@pay.com</h3>
<input class="input-style" type="text" name="transactionId" placeholder="Enter Transaction Id" required>
<h3 style="color: orange">*If you select online Payment then enter you transaction ID here otherwise leave this blank</h3>
</div>
<hr style="width: 100%">
...
<h3 style="color: orange">*This mobile number will also updated to your profile</h3>
</div>
<div class="right-div">
<h3 style="color: orange">*If you enter wrong transaction id then your order will we can cancel!</h3>
<button class="button" type="submit">Proceed to generate Bill & Save <i class='far fa-arrow-alt-circle-right'></i></button>
<h3 style="color: orange">*Fill form correctly</h3>
</div>
</form>
<%
}
